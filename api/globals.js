// Lee métricas desde Supabase cache (escrito por _sync_metrics.mjs cada 30 min)
// Nunca golpea GHL en vivo — elimina el problema de rate limit

const SB_URL = process.env.IF_SUPABASE_URL;
const SB_KEY = process.env.IF_SUPABASE_KEY;

const CACHE_KEY    = 'metrics_globals';
const MAX_AGE_MS   = 2 * 60 * 60 * 1000; // 2 horas: si más viejo que esto, marcar como stale
